...
export function AegisLogo({ size = 32, glow = true, className = "" }) {
  const glowFilter = glow ? "drop-shadow(0px 0px 10px rgba(56, 189, 248, 0.6))" : "none";
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          <linearGradient id="wayfarerAegisGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <linearGradient id="wayfarerCoreGrad" x1="50%" y1="0%" x2="50%" y2="100%">
